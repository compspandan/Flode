    ...
    return (
        <View style={styles.center}>
            ...
            <View style={styles.problemContainer}>
                <Text style={styles.problem}>{problemStatement}</Text>
            </View>
        </View>
    );
};
